...
> _"Quem aqui consegue me dizer o que mudou no dashboard da sua empresa na
> semana passada, e quem mudou? Dashboard clicado não tem diff, não tem revisão
> e não tem rollback."_
...
> _"Dashboard clicado, quando alguém apaga, acabou — e normalmente a pessoa que
> sabia montar já saiu da empresa."_
...
> _"Esse dashboard responde exatamente as mesmas perguntas do que vocês viram
...
> código, e ninguém mais precisa lembrar de qual coluna converter._
>
> _E o principal: se eu apagar esse dashboard agora, um `deploy` traz ele de
> volta idêntico. Dashboard clicado, se alguém apagar, acabou — e normalmente
> a pessoa que sabia montar já saiu da empresa."_
