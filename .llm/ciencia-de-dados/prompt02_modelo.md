...
**Slides que acompanham:** 24 a 36 (divisor _"O modelo"_, o problema escrito em
...
_"MLflow"_, a pergunta de daqui a seis meses, o que o MLflow resolve, o modelo
do lado das tabelas).
...
> _"Sem modelo nenhum. Você tem 200 ligações e 3.000 clientes. Qual coluna você
> ordena?"_
...
> _"Se eu sortear 200 nomes num chapéu, essa é a fração que compra sozinha.
> Qualquer coisa que a gente construir hoje precisa ganhar disso — senão o
> projeto não se paga."_
...
> _"Se qualquer coluna à esquerda souber de algo à direita, o AUC vem 0,98 e o
...
E a tabela que responde o diretor, com os três números do slide _Não é acurácia_ lado a lado:
...
catálogo, mesma linhagem, mesmo GRANT.** É o slide _“Esse modelo ainda está bom?”_ respondido: qual versão
...
> _"Este job quebra se o resultado ficar bom demais. É a única defesa que
