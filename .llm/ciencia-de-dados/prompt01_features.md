...
**Slides que acompanham:** 16 a 23 (divisor _"O que descreve um cliente"_, **o
que é feature engineering**, de _"O que descreve um cliente"_, de
...
> _"Duas noites de trabalho responderam tudo sobre o passado. O diretor não
> perguntou nada sobre o passado — ele perguntou quais 200. E modelo não come
> tabela fato: ele come uma linha por coisa que você quer prever."_
...
- **Uma função, dois usos.** A mesma `montar_features()` gera o dado de treino
  ...
  esse desencontro tem nome, _training/serving skew_, e é o que o Feature Store
...
> **Anote os dois números no quadro.** É o "20" do slide _Não é acurácia_, e todo o prompt 2 é
...
| `menor_recencia` negativa                              | filtro `< referencia` faltou em uma fonte                  | mostre ao vivo: é o slide _Prever a semana que vem com informação da semana que vem_ acontecendo         |
