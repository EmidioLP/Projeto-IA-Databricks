...
> Genie direto na bronze e avisou ao vivo: _"pode dar certo e pode dar errado,
> não fui eu que limpei esses dados"_. Hoje você mostra a diferença.
...
> _"Ninguém da diretoria pergunta por `mart_produto_performance`. Perguntam
> 'quais marcas estão vendendo' e 'quem parou de comprar'."_
...
> _"Quais marcas mais venderam nos últimos 6 meses?"_

Guarde o SQL que ele gerou (o botão _Show generated code_). Você vai comparar
...
- **View com nome de negócio.** Ninguém da diretoria pergunta por
  `fato_vendas`. Perguntam por _ranking de marcas_ e _clientes em risco_. A
...
> _"Metadado faltando não é pendência de documentação. É bug — porque a partir
> de hoje tem um agente lendo esse comentário para decidir qual coluna usar."_
...
Abra o _Show generated code_ e coloque lado a lado com o SQL que você guardou
...
> _"Quais clientes pararam de comprar, e quanta receita a gente perdeu com isso?"_
...
> varejo já está abastecido após os picos de vendas anteriores."_
...
> _"Ontem eu pluguei o Genie direto na bronze e falei para vocês, com todas as
> letras: pode dar certo, pode dar errado, não fui eu que limpei esses dados._
>
> _Hoje eu sei que está certo. E não é porque o modelo ficou mais inteligente
> de ontem para hoje — é o mesmo modelo. É porque eu construí o caminho inteiro
> e testei cada passo._
>
> _Engenharia de dados não é o que a IA substitui. É o que faz a IA funcionar."_
...
| O Genie responde que dezembro foi ruim             | A instrução de sazonalidade não entrou         | _"Reforce no texto que dezembro e janeiro são vale ESPERADO, e que ele nunca deve chamar isso de queda."_ |
