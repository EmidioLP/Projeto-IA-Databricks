...
**Slides que acompanham:** 25 a 33 (divisor _"Uma URL"_, o que é Databricks
...
| Genie `Rota do Perfume · Direção` | criado no prompt 1 — é o que entra na aba _Perguntar_          |
...
> _"Está certíssimo. Agora imagine mandar isso para o diretor comercial toda
...
> ligar pela intuição."_

**2 · A pergunta que decide o desenho — faça para a sala**

> _"Dashboard, Genie e app leem a mesma tabela. Por que três?"_
...
> _"Vou explicar daqui a pouco por que isso não é frescura."_

---

**Enquanto ele trabalha, você explica:**

- **O app é um usuário do Unity Catalog.** Ele nasce com um _service principal_
...
O cartão _Já trabalhados_ mostra **0**, e a aba _Acompanhamento_ — se você já
a construiu — está vazia. Ninguém ligou ainda. É o gancho do prompt 3.

**4 · O filtro por vendedor**

Escolha _Débora Souza_: **12 contatos**, o maior número da fila. Escolha um
vendedor com poucos e mostre o estado vazio explicando que a fila é global.

**5 · A aba Perguntar responde com o SQL à vista**

Pergunte _"quanto vale a fila desta semana?"_ dentro do app e mostre o SQL
